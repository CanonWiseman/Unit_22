...
--8. SELECT app_name FROM analytics WHERE min_installs < 50 ORDER BY rating DESC; --
--9. SELECT app_name FROM analytics WHERE rating < 3 AND reviews > 10000;--
--10. SELECT app_name FROM analytics WHERE price BETWEEN .10 AND 1.00 ORDER BY reviews DESC LIMIT 10;--
...
--14. SELECT category, COUNT(app_name) AS apps_total FROM analytics GROUP BY category HAVING COUNT(*) > 300; --
--15. SELECT app_name, min_installs/reviews AS proportion, min_installs, reviews FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;--